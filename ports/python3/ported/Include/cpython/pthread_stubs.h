...
/* amiport: bebbo-gcc newlib has forward-declared pthread types in
 * sys/_pthreadtypes.h (incomplete — can't be used as struct fields).
 * We need concrete types for CPython's GIL structs. Block the system
 * header and define our own concrete types matching CPython's stubs. */
