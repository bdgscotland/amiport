/*
 * config.c -- S:amiget.conf configuration file parser
 *
...
#define CONFIG_PATH "S:amiget.conf"
#define DEFAULT_SERVER "http://amiport.platesteel.net"
#define DEFAULT_INSTALLPATH "C:"

static void set_defaults(struct amiget_config *cfg)
{
        ...
        *eq = '\0';
        ...
        if (strcmp(key, "server") == 0) {
            ...
            if (strncmp(value, "https://", 8) == 0) {
                fprintf(stderr, "amiget: warning: HTTPS not supported "
