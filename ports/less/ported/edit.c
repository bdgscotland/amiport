...
/* amiport: guard close_pipe with HAVE_POPEN since pclose is not in libnix */
#if HAVE_POPEN
/*
...
#else /* !HAVE_POPEN */
/* amiport: stub close_pipe when popen not available */
static void close_pipe(FILE *pipefd) { (void)pipefd; }
#endif /* HAVE_POPEN */
