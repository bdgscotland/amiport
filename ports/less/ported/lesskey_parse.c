/* amiport: lesskey_parse.c — copied from original without modification.
 * Pure C, no POSIX deps. Provides parse_lesskey() and parse_lesskey_content()
 * for in-process lesskey file parsing (HAVE_LESSKEYSRC=1).
 */
/*
