...
/* amiport: Amiga exit codes — 0=OK, 5=WARN, 10=ERROR, 20=FAIL
 * QUIT_OK=0 (RETURN_OK), QUIT_INTERRUPT=5 (RETURN_WARN), QUIT_ERROR=10 (RETURN_ERROR) */
#ifdef __AMIGA__
#define QUIT_OK         0
#define QUIT_ERROR      10
#define QUIT_INTERRUPT  5
#else
#ifdef EXIT_SUCCESS
