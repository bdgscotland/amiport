...
/* amiport: AmigaOS stack and version string */
#ifdef __AMIGA__
long __stack = 65536;
static const char __attribute__((used)) verstag[] = "$VER: less 692 (24.03.2026)";
/* amiport: __progname — defensive define; less uses its own progname variable */
char *__progname = "less";
#endif
...
public void quit(int status)
{
	...
	close_getchr();
#ifdef __AMIGA__
	/* amiport: free leaked globals — AmigaOS has no process memory cleanup
