...
extern	Node	*awk_concat(Node *);	/* amiport: renamed from concat -- clashes with libnix string.h */
#define concat awk_concat
...
/* amiport: popen/pclose are provided as macros by amiport-emu/popen.h --
 * suppress the extern declarations to avoid macro-expansion errors. */
#ifndef popen
