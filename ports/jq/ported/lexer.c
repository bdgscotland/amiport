 ...
 */
/* amiport: replaced <unistd.h> with amiport shim — provides isatty() */
#include <amiport/unistd.h>
/* amiport: exec/types.h defines IMPORT as extern, conflicting with jq's
   IMPORT token. Undef it here so the token enum value is used correctly. */
#ifdef IMPORT
# undef IMPORT
#endif
#endif
...
#define YY_EXIT_FAILURE 20 /* amiport: RETURN_FAIL — was 2 */
#endif
