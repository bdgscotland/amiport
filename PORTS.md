...
|------|---------|-------------|----------|----------|--------|--------|
| [amigit](ports/amigit/) | 0.2 | Git client for AmigaOS 3.x over HTTPS | CLI | amiport-native (hand-written on libgit2 1.8.5) | **Developer preview** -- 103/103 FS-UAE, clone + ls-remote over HTTPS (PDR-012 Phase 8) | Not submitted |
