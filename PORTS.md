...
|------|---------|-------------|----------|----------|--------|--------|
| [amigit](ports/amigit/) | 0.1-3 | Local-only git client for AmigaOS 3.x | CLI | amiport-native (hand-written on libgit2 1.8.5) | Built & tested (82/82 FS-UAE) | Not submitted |
