...
|------|---------|-------------|----------|----------|--------|--------|
| [amigit](ports/amigit/) | 0.1-7 | Local git CLI for AmigaOS 3.x (preview) | CLI | amiport-native (hand-written on libgit2 1.8.5) | **Developer preview** -- 100/100 FS-UAE, HTTPS auth wired (PDR-012 Phase 7), not yet stable for daily use | Not submitted |
...
| [tail](ports/tail/) | 1.24-2 | Display last part of a file | CLI | OpenBSD tail v1.24 (BSD 3-Clause) | Built & tested (21/21 FS-UAE) | Not submitted |
...
| [jq](ports/jq/) | 1.7.1-3 | Lightweight command-line JSON processor | CLI | jqlang jq 1.7.1 (MIT) + Oniguruma 6.9.9 (BSD) | Built & tested (60/60 FS-UAE) | Submitted 2026-03-23 |
...
| [dropbear](ports/dropbear/) | 2025.89 | SSH client for AmigaOS (68020+) | Network | Dropbear 2025.89 (MIT) | In progress | Not submitted |
