...
|------|---------|-------------|----------|----------|--------|--------|
| [amigit](ports/amigit/) | 0.1-6 | Local git CLI for AmigaOS 3.x (preview) | CLI | amiport-native (hand-written on libgit2 1.8.5) | **Developer preview** -- 87/87 FS-UAE, not yet stable for daily use | Not submitted |
