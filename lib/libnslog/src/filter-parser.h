...
#ifndef YY_FILTER_TMP_LIBNSLOG_GEN_FILTER_PARSER_H_INCLUDED
# define YY_FILTER_TMP_LIBNSLOG_GEN_FILTER_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef FILTER_DEBUG
# if defined YYDEBUG
#if YYDEBUG
...
union FILTER_STYPE
{
#line 31 "src/filter-parser.y"

	char *patt;
	nslog_level level;
	nslog_filter_t *filter;

#line 89 "/tmp/libnslog-gen/filter-parser.h"
...
#endif /* !YY_FILTER_TMP_LIBNSLOG_GEN_FILTER_PARSER_H_INCLUDED  */
