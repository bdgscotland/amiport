 ...
 */
   ...
   *
   * Bzier segments are flattened by splitting them until their deviation
   * from straight line becomes much smaller than a pixel.  Therefore, the
   * pixel coverage by a Bzier curve is calculated approximately.  To
...
#define LEFT_SHIFT( a, b )  (FT_Int64)( (FT_UInt64)(a) << (b) )
  ...
  /*
   * For cubic Bzier, binary splits are still faster than DDA
