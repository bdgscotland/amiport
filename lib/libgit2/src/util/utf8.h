 ...
 *
 * In other words (amiport: non-ASCII example characters removed for
 * bebbo-gcc UTF-8 safety, see known-pitfalls):
 *   0x24 (U+0024 ASCII '$') has length 1
 *   0xc2 0xa2 (U+00A2 CENT SIGN, 2 UTF-8 bytes) has length 1
 *   0x24 0xc2 0xa2 (U+0024 U+00A2, 3 UTF-8 bytes) has length 2
 *   0xf0 0x90 0x8d 0x88 (U+10348 GOTHIC LETTER AHSA, 4 UTF-8 bytes) has length 1
